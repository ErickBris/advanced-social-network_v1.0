package com.atouchlab.socialnetwork.app;

public class AppConst {
    public static final String TAG = "atouch";
    public static final String MAIN = "http://192.168.1.10/EnvatoNetwork";
    ...
    public static final String GOOGLE_PROJ_ID = "540984294728";//confComm
    public static final String APK_KEY = "AIzaSyAqde5WbMrLVRFDBO_n3KA90Nh5sOVS0yY";
